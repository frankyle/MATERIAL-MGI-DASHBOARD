...
const RiskTrades = () => {
  ...
  return (
    <div className="overflow-x-auto shadow-md sm:rounded-lg">
      ...
      {riskTrades.length > 0 && (
        <div className="my-6 w-full h-96">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={riskTrades}>
              <CartesianGrid strokeDasharray="3 3" />
              <XAxis dataKey="date" /> 
              <YAxis domain={[0, 100]} />
              <Tooltip />
              <Legend />
              <Bar dataKey="risk_dollars" fill="#ff4d4d" name="Risk (USD)" />
              <Bar dataKey="gain_dollars" fill="#4CAF50" name="Gain (USD)" />
 ...
 {riskTrades.length > 0 && (
  <div className="my-6 w-full h-96">
    <h2 className="text-lg font-bold text-center mb-2">Gain in USD Over Time</h2>
    <ResponsiveContainer width="100%" height="100%">
      <LineChart
        data={[{ date: '', gain_dollars: 0 }, ...riskTrades]}
